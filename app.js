...
var createNewTaskElement=function(taskString){
    ...
    checkBox.className ='task__input-field task__input-field--checkbox';
    ...
    editInput.type="text";
    editInput.className="task__input-field task__input-field--text";
...
var editTask=function(){
    ...
    var containsClass=listItem.classList.contains("task__list-item--edit-mode");
    ...
    listItem.classList.toggle("task__list-item--edit-mode");
};
